<div class="w-full md:w-24 fixed left-0 md:top-0 bottom-0 right-0 md:h-screen flex items-center flex-row md:flex-col gap-8 py-4 bg-surface-200 dark:bg-surfacedark-200 z-50">
    <!-- logo -->
    <a href="/" target="_blank" class="hidden md:flex relative mb-8">
        <div aria-label="Cursed" data-microtip-position="right" role="tooltip">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" version="1.0" viewBox="0 0 317.000000 319.000000"
                preserveAspectRatio="xMidYMid meet">
                <g transform="translate(0.000000,319.000000) scale(0.100000,-0.100000)" fill="currentColor"
                    stroke="none">
                    <path class="fill-primary-200 dark:fill-primary-600"
                    ...
                    <path class="fill-primary-600 dark:fill-primary-200"
    ...
    <div class="w-full md:w-auto justify-center flex flex-row md:flex-col items-center md:gap-4">
        <a href="/courses/index"
            class="{{ Request::is('courses/index') ? 'active' : '' }} group min-h-[56px] w-1/4 md:w-auto flex flex-col items-center justify-center px-0 gap-1">
            <div
            ...
            <p class="text-xs text-neutral-900 dark:text-neutral-100 tracking-[.0416em] leading-tight">Ваши курсы</p>
        </a>
       
        <a href="/courses/create"
            class="{{ Request::is('courses/create') ? 'active' : '' }} group min-h-[56px] w-1/4 md:w-auto flex flex-col items-center justify-center px-0 gap-1">
            <div
                class="relative w-14 h-8 hover-icon group-hover:bg-secondary-100 dark:group-hover:bg-secondary-700 group-hover:bg-opacity-80 dark:group-hover:bg-opacity-80 flex items-center justify-center rounded-2xl">
                <span class="material-symbols-outlined">format_paint</span>
            </div>
            <p class="text-xs text-neutral-900 dark:text-neutral-100 tracking-[.0416em] leading-tight">Создать курс</p>
        </a>

        <a href="/exercise/create"
            class="{{ Request::is('exercise/create') ? 'active' : '' }}  group min-h-[56px] w-1/4 md:w-auto flex flex-col items-center justify-center px-0 gap-1">
            <div
                class="relative w-14 h-8 hover-icon group-hover:bg-secondary-100 dark:group-hover:bg-secondary-700 group-hover:bg-opacity-80 dark:group-hover:bg-opacity-80 flex items-center justify-center rounded-2xl">
                <span class="material-symbols-outlined">sports</span>
            </div>
            <p class="text-xs text-neutral-900 dark:text-neutral-100 tracking-[.0416em] leading-tight">Задания</p>
        </a>
        <a href="/stats"
            class="{{ Request::is('stats') ? 'active' : '' }} group min-h-[56px] w-1/4 md:w-auto flex flex-col items-center justify-center px-0 gap-1">
            <div
                class="relative w-14 h-8 hover-icon group-hover:bg-secondary-100 dark:group-hover:bg-secondary-700 group-hover:bg-opacity-80 dark:group-hover:bg-opacity-80 flex items-center justify-center rounded-2xl">
                <span class="material-symbols-outlined">query_stats</span>
            </div>
            <p class="text-xs text-neutral-900 dark:text-neutral-100 tracking-[.0416em] leading-tight">Статистика</p>
        </a>
        <a href="/settings"
            class="{{ Request::is('settings') ? 'active' : '' }} group min-h-[56px] w-1/4 md:w-auto flex flex-col items-center justify-center px-0 gap-1">
            <div
                class="relative w-14 h-8 hover-icon group-hover:bg-secondary-100 dark:group-hover:bg-secondary-700 group-hover:bg-opacity-80 dark:group-hover:bg-opacity-80 flex items-center justify-center rounded-2xl">
                <span class="material-symbols-outlined">settings</span>
            </div>
            <p class="text-xs text-neutral-900 dark:text-neutral-100 tracking-[.0416em] leading-tight">Настройки</p>
        </a>
    ...
    <div class="hidden md:flex flex-col items-center gap-3 mt-auto">
        <!-- light dark -->
        <div class="relative" aria-label="Тема" data-microtip-position="top" role="tooltip">
            <!-- light & dark -->
